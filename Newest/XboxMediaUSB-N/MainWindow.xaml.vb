    ...
    Private Sub CheckConfigAndLanguage()
        ...
        If Not File.Exists(My.Computer.FileSystem.CurrentDirectory + "\languages\EN.ini") Then
            Using EnglishFileWriter As New StreamWriter(My.Computer.FileSystem.CurrentDirectory + "\languages\EN.ini", False, Encoding.GetEncoding("ISO-8859-1"))
                ...
                EnglishFileWriter.WriteLine("SelectLabel1=Select a USB drive from the list :")
                EnglishFileWriter.WriteLine("SelectLabel2=Select a USB drive from the list :")
                ...
                EnglishFileWriter.WriteLine("SetPermissionGroupBox=Set permissions on USB")
                EnglishFileWriter.WriteLine("SetPermissionsButton=Set permissions on USB")
                EnglishFileWriter.WriteLine("Options=Options :")
                EnglishFileWriter.WriteLine("CreateDefaultFolders=Create emulation folders")
                ...
                EnglishFileWriter.WriteLine("FormatSucceeded=Successfully formatted!")
                EnglishFileWriter.WriteLine("CreateDefaultFolders=Do you want to create the 'Games' and 'Emulation' folders on your USB?")
                EnglishFileWriter.WriteLine("SettingPermissions=Setting 'ALL APPLICATION PACKAGES' permissions on")
                ...
                EnglishFileWriter.WriteLine("CouldNotSetPermissions=Could not set permission for 'ALL APPLICATION PACKAGES' on drive, is it NTFS?")
