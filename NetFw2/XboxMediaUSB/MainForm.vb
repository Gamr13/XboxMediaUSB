    ...
    Private Sub CheckConfigAndLanguage()
        ...
        If Not File.Exists(My.Computer.FileSystem.CurrentDirectory + "\languages\EN.ini") Then
            Using EnglishFileWriter As New StreamWriter(My.Computer.FileSystem.CurrentDirectory + "\languages\EN.ini", False, System.Text.Encoding.GetEncoding("ISO-8859-1"))
                ...
                EnglishFileWriter.WriteLine("SetPermissionGroupBox=Only set permissions")
                EnglishFileWriter.WriteLine("SetPermissionsButton=Set permissions on selected USB drive.")
                ...
                EnglishFileWriter.WriteLine("CreateDefaultFolders=Do you want to create the 'Games' and 'Emulators' folders on your USB?")
